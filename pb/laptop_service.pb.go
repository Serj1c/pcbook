...
type CreateLaptopRequest struct {
	...
	Laptop *__.Laptop `protobuf:"bytes,1,opt,name=laptop,proto3" json:"laptop,omitempty"`
}
...
func (x *CreateLaptopRequest) GetLaptop() *__.Laptop {
	if x != nil {
		return x.Laptop
	}
	return nil
...
func (x *SearchLaptopResponse) GetLaptop() *__.Laptop {
	if x != nil {
		return x.Laptop
	}
	return nil
...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x07,
