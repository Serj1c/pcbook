...
type Laptop struct {
	...
	Cpu      *__.CPU       `protobuf:"bytes,4,opt,name=cpu,proto3" json:"cpu,omitempty"`
	Ram      *__.Memory    `protobuf:"bytes,5,opt,name=ram,proto3" json:"ram,omitempty"`
	Gpus     []*__.GPU     `protobuf:"bytes,6,rep,name=gpus,proto3" json:"gpus,omitempty"`
	Storages []*__.Storage `protobuf:"bytes,7,rep,name=storages,proto3" json:"storages,omitempty"`
	Screen   *__.Screen    `protobuf:"bytes,8,opt,name=screen,proto3" json:"screen,omitempty"`
	Keyboard *__.Keyboard  `protobuf:"bytes,9,opt,name=keyboard,proto3" json:"keyboard,omitempty"`
...
func (x *Laptop) GetRam() *__.Memory {
	if x != nil {
		return x.Ram
	}
	return nil
...
func (x *Laptop) GetStorages() []*__.Storage {
	if x != nil {
		return x.Storages
	}
	return nil
...
func (x *Laptop) GetScreen() *__.Screen {
	if x != nil {
		return x.Screen
	}
	return nil
...
func (x *Laptop) GetKeyboard() *__.Keyboard {
	if x != nil {
		return x.Keyboard
	}
	return nil
...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x16,
...
var file_laptop_message_proto_goTypes = []interface{}{
	...
	(*__.CPU)(nil),                // 1: pcbook.CPU
	(*__.Memory)(nil),             // 2: pcbook.Memory
	(*__.GPU)(nil),                // 3: pcbook.GPU
	(*__.Storage)(nil),            // 4: pcbook.Storage
	(*__.Screen)(nil),             // 5: pcbook.Screen
	(*__.Keyboard)(nil),           // 6: pcbook.Keyboard
